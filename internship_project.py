# -*- coding: utf-8 -*-
# run this file on colab or on a jupyter notebook
...
# @title 🛠️ Professional Password Security Toolkit (v2.0)
...
class PasswordSecurityEngine:
    ...
    def _print_analysis_report(self, r):
        print(f"\n{'='*40}")
        print(f"🛡️ SECURITY AUDIT: {r['password']}")
        print(f"{'='*40}")
